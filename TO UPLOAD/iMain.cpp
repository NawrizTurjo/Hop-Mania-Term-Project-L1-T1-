...
char bg[][100]= {"bg\\car.bmp","bg\\opening.bmp","bg\\truck.bmp","bg\\block.bmp","bg\\car2.bmp","bg\\car3.bmp","bg\\ending.bmp","bg\\barrier.bmp","bg\\road.bmp","bg\\water.bmp","bg\\main_bg.bmp","bg\\difficulty.bmp"};
char buttons[][100]= {"buttons\\PLAY.bmp","buttons\\HIGH.bmp","buttons\\END.bmp","buttons\\over.bmp","buttons\\score.bmp"};
...
void show_life()
{
    ...
    iText(90,218,strlife,GLUT_BITMAP_HELVETICA_18);
}
